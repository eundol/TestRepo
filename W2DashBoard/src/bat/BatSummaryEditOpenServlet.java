...
public class BatSummaryEditOpenServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        RequestDispatcher view = request.getRequestDispatcher("bat/bat_summary_edit_data.jsp");
        System.out.println("go to " + "bat/bat_summary_edit_data.jsp");

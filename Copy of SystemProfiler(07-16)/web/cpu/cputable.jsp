...
<div style="height: 0px; background-color: white;" id="redLine0"></div>
<div style="height: 1px; background-color: #24618E;" id="redLine"></div>
<div style="height: 2px; background-color: white;" id="redLine2"></div>

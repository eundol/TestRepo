...
//			}
	...
	public void getCpuTable1000(ArrayList<CpuEntity> cpuTable, String id) {
		System.out.println("getCpuTable1000-dao **");
		CpuEntity entity = null;
		PreparedStatement psmt = null;
		ResultSet rset = null;
		String query = "select overhead, command, shared_object, symbol, cpu, pid, child, parent, src_line from cpu_usage where profile_id = ? limit 1000";
		int cnt = 0;
			try {
				psmt = conn.prepareStatement(query);
				psmt.setString(1, id);
...
//			}
	...
	public void getCpuSearchResult(ArrayList<CpuSearchEntity> cpuSearchResult,String userId) {
		...
		PreparedStatement psmt = null;
		ResultSet rset = null;
		String query = "select profile_id,created,file_name,test_case_id,test_date,user_id from common where user_id like ? order by 1 desc";
	...
	public void getCpuSummary(CpuSummaryEntity cpuSummary, String id) {
		...
		PreparedStatement psmt = null;
		ResultSet rset = null;
		String query = "select file_name, test_case_id, test_date, user_id from common where profile_id = ?";

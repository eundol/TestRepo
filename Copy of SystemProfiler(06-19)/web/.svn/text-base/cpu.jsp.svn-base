...
<!-- Charts Start -->
<div id="summaryDiv" style="margin-top: 10px; width: 35%; height: 340px; float: left; padding-left: 0px">
	<iframe id="summary" name="summary" src=".<%=cpuSummary%>" width="100%" height="100%" scrolling="no" frameborder="0">
	</iframe>
</div>
<div id="cpuCoreDiv" style="margin-top: 10px; width: 29%; height: 340px; float: left; padding-left: 0px">
	<iframe id="cpuCore" name="cpuCore" src=".<%=cpuCore%>" width="100%" height="100%" scrolling="no" frameborder="0">
	</iframe>
</div>
<div id="cpuFunctionDiv" style="margin-top: 10px; width: 32%; height: 340px; float: right; padding-right: 37px" >
...
<!-- Cpu Table Start -->
<div id="cpuTableDiv" style="margin-top: 9px; width: 98%; height: 499px; float: left; padding-left: 15px;">
	<iframe id="cpuTable" name="cpuTable" src=".<%=cpuTable%>" width="100%" height="100%" scrolling="no" frameborder="0" style="height: 100%">
	</iframe>
</div>
<!-- Cpu Table End -->

<div style="width:100%; height: 22px; float: left; color: white;"></div>

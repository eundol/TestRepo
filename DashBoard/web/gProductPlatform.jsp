			...
			<div class="container">
				...
				<div class="nav-collapse collapse">
					<ul class="nav">
						...
						<li class="productPlatform"><a href="gProductPlatform.jsp"
...
.productPlatform {
	...
	<div id="temp" style="float: left; margin-top: 30px; margin-left: 570px">
		<h6>
	...
	<!-- (2) Show Bar Chart -->
	<div id="gProduct_barChart">
		<jsp:include page="/productBarChart" />
	</div>

	<!-- (3) Show Area Chart --> 
	<div id="gProduct_areaChart">
		<jsp:include page="/productAreaChart" />
	</div> 

	<!-- (4) Show Table  -->
	<div id="gProduct_table" style="margin-left: 10px">
		<jsp:include page="/productTable" />
	</div>

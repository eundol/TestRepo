			...
			<div class="container">
				...
				<div class="nav-collapse collapse">
					<ul class="nav">
						...
						<li class="commonPlatform"><a href="gCommonPlatform.jsp"
...
.commonPlatform {
	...
	<!-- (2) Show Bar Chart -->
	<div id="gCommon_barChart">
		<jsp:include page="/commonBarChart" />
	</div>

	<!-- (3) Show Area Chart --> 
	<div id="gCommon_areaChart">
		<jsp:include page="/commonAreaChart" />
	</div> 
	
	<!-- (4) Show Table  -->
	<div id="gCommon_table" style="margin-left: 10px ;">
		<jsp:include page="/commonTable" />
	</div>

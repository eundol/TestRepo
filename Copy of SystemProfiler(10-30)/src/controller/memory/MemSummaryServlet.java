...
public class MemSummaryServlet extends HttpServlet {
...
//    	    biz.getCpuSummaryTotal(cpuSummary, id);
		...
		RequestDispatcher view = request.getRequestDispatcher("memory/summary.jsp");
//		System.out.println("go to memory/summary.jsp");

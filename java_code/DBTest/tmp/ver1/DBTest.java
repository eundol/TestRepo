        ...
        public static void main(String[] args){
                ...
                while(i<=6){
                        if(i==1)
                        	...
                        	test.sqlQueryEnter(4);
                        else if(i==5)
                        	test.sqlQueryEnter(5);
                        else if(i==6)
                        	test.sqlQueryEnter(6);
                        else
                                ;
	...
	public void weekUpdate()
	{
		 // Update Week Column ***************   
                ...
                try {
                        ...
                        writeLog("ERROR : executeUpdate error... insertString - "+weekUpdateStr);
...
//                                      chk_++;
                ...
                for(int i=1 ; i<=resultMap.size(); i++){                // '<' -> '<='
                        ...
                        for(String s2:s){
                                ...
                                if(temp_str==null){
                                        ...
                                        else {  // if there is null in the 1st sentence
                                                temp_str = "NULL";
			...
			if(table1_flag == 1)
                       		data_string = data_temp_string + ", NULL)";
			else
...
//                      System.out.println("#########executeQuery success!!#########");
        ...
        public void sqlQueryEnter(int n)
        {
                if(n==1){
                	...
                	table_name = "patch_comments";
                	System.out.println("....................TABLE <patch_comments>....................");
                }
                else if(n==5){
                	sqlQuery = "select * from patch_sets;";
                	table_name = "patch_sets";
                	System.out.println("....................TABLE <patch_sets>....................");
                }
                else if(n==6){
                	sqlQuery = "select * from patch_set_approvals;";
                	table_name = "patch_set_approvals";
                	System.out.println("....................TABLE <patch_set_approvals>....................");
                }

...
public class CpuBiz {
	...
	public void getCpuTable100(ArrayList<CpuEntity> cpuTable, String id) {
		System.out.println("getCpuTable100-biz **");
		Connection conn = JdbcTemplate.getConnection();
		CpuDao dao = new CpuDao(conn);
		dao.getCpuTable100(cpuTable, id);
		JdbcTemplate.close(conn);
		return;
	}
	...
	public void getCpuTableGroupBy(ArrayList<CpuEntity> cpuTable, String id) {
		...
		Connection conn = JdbcTemplate.getConnection();
		CpuDao dao = new CpuDao(conn);
		dao.getCpuTableGroupBy(cpuTable, id);
		JdbcTemplate.close(conn);
		return;
	}
	...
	public void getCpuProcessInfo(String id, ArrayList<CpuEntity> cpuProcessInfo) {
		System.out.println("getCpuProcessInfo-biz **");
		Connection conn = JdbcTemplate.getConnection();
		CpuDao dao = new CpuDao(conn);
		dao.getCpuProcessInfo(cpuProcessInfo, id);
		JdbcTemplate.close(conn);
	}

...
public class IoBiz {
	...
	public void getIotopInformation(String id, ArrayList<IotopEntity> iotopInfo) {
		System.out.println("getIotopInformation-biz**");
		Connection conn = JdbcTemplate.getConnection();
		IoDao dao = new IoDao(conn);
		dao.getIotopInformation(id, iotopInfo);
		JdbcTemplate.close(conn);
		return;
	}

	public void getIotopCommandOrderByRead(String id, ArrayList<String> iotopCommandOrder) {
		System.out.println("getIotopCommandOrderByRead-biz**");
		Connection conn = JdbcTemplate.getConnection();
		IoDao dao = new IoDao(conn);
		dao.getIotopCommandOrderByRead(id, iotopCommandOrder);
		JdbcTemplate.close(conn);
		return;
	...
	public void getIotopCommandOrderByWrite(String id, ArrayList<String> iotopCommandOrder) {
		System.out.println("getIotopCommandOrderByWrite-biz**");
		Connection conn = JdbcTemplate.getConnection();
		IoDao dao = new IoDao(conn);
		dao.getIotopCommandOrderByWrite(id, iotopCommandOrder);
		JdbcTemplate.close(conn);
		return;
	...
	public void getIotopHighreadInformation(String id, ArrayList<IotopEntity> iotopInfo) {
		...
		Connection conn = JdbcTemplate.getConnection();
		IoDao dao = new IoDao(conn);
		dao.getIotopHighreadInformation(id, iotopInfo);
		JdbcTemplate.close(conn);
		return;
	}

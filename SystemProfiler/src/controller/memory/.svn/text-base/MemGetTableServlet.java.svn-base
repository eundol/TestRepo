...
public class MemGetTableServlet extends HttpServlet {
...
//        System.out.println("id : " + id);
		...
		RequestDispatcher view = request.getRequestDispatcher("memory/memtable.jsp");
		System.out.println("go to memory/memtable.jsp");

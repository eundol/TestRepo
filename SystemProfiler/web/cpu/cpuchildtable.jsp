...
<%if(srcLine != null && !srcLine.equals("")){%> 
	...
	<div style="padding-left: 20px;"><span style="font-weight: normal;"><%=srcLine%></span></div>
<%}%>

<div style="height: 10px;"></div>
<div style="height: 1px; background-color: #8E8E8E; width: 98%; margin-left: 1%;"></div>


<%if(child != null && !child.equals("") && !child.equals("null")){ %>
	<div style="margin-top: 10px;">
	<div style="margin-top: 3px; color: #B22222;">
		<b>&nbsp;ㆍCall Chain Info</b>
	</div>
	...
	<%  ArrayList<String[]> compareChildArray = new ArrayList<String[]>();
		...
		<div style="height: 1px;"></div>
			...
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font color="#000000" style="font-weight: normal;">- No data were found to match this function.</font>
			<%}else{%>
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <span style="font-weight: normal;"><%=childArray.get(i)%></span>
			<div style="height: 2px"></div>
			<%}
			...
			<%	}else if(printString.length == 3){
				...
				<font style="font-family: 'Lucida Grande', 'Lucida Sans Unicode', Verdana, Arial, Helvetica, sans-serif; color:#266493; font-size:13px; padding-left: 80px; font-weight: normal;">└&nbsp;
					<%=printString[1]%></font>
					<%
				}
		%>
...
<div style="position: fixed; right: 3px; top: 3px; ">
	<font style="vertical-align: bottom; cursor: pointer; color: white; font-size: 16px" title="close"><a onclick="javascript:childPageClose();" class="close">▶&nbsp;</a></font>
</div>
<%-- ShortCut Icon End--%>

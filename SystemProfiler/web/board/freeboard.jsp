		...
		<c:forEach items="${board}" var="entity" varStatus="status">
			<tr id="comment" style="background-color: #F4F4F4;" 
				...
				<td width="130px" style="text-align: center;">
					...
					<c:if test = "${entity.name=='Connector'}">
						<img src="./img/Mushroom-Super-icon.png" style="width: 13px; height: 13px; vertical-align: middle;">
					</c:if>
					<c:if test = "${entity.name=='Right-handed'}">
						<img src="./img/hand-icon.png" style="width: 13px; height: 13px; elevation:lower;">
					</c:if>
				</td>
				<td width="130px" style="text-align: center;">
					${entity.created}

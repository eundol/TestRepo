...
enyo.kind({
	...
	selectionScrimIcon: "../images/watch_square_check.png",
...
enyo.kind({
	...
	components: [{
		...
		spacing: 0,
		style: "width: 260px; height: 320px; margin: auto; background-color: #212121;",
		components: [{
...
enyo.kind({
	...
	components: [{
		...
		{
			content: "Data Grid List [Unselectable / Single Selection / Multiple Selection]",
	...
	bindings: [{
		...
		from: ".collection",
		to: ".$.gridListSingle.collection"
	}, {
		from: ".collection",
		to: ".$.gridListMulti.collection"
	}],
	create: enyo.inherit(function(sup) {
		return function() {
			sup.apply(this, arguments);

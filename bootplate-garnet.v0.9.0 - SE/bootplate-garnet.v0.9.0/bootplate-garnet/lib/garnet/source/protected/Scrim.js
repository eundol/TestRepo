//* @protected
/**
	_g.Scrim_ provides an overlay that will prevent taps from propagating to
	...
	The scrim should have a CSS class of _"g-scrim-transparent"_,
	_"g-scrim-translucent"_,	or any other class that has
...
enyo.kind({
	...
	create: enyo.inherit(function(sup) {
		return function() {
			...
			if (this.floating) {
				...
				this.parent.addRemoveClass("g", true); // garnet
			}
		};
	}),
	...
	*/
	...
	/**
		...
		> inZIndex:
		>> The specific z-index you want to remove from stack.
...
new g.scrimSingleton("g.scrim", {floating: true, classes: "g-scrim-translucent"});
new g.scrimSingleton("g.scrimTransparent", {floating: true, classes: "g-scrim-transparent"});

    ...
    if (window.ilib) {
        ...
        funLocaleSpecificFonts = function() {
            var loc = new ilib.Locale(),
                ...
                fontFamilyRegular = 'NewSmartGothic-Regular',
                fontFamilyBold    = 'NewSmartGothic-Bold',
                fontFamilyLight   = 'NewSmartGothic-Light',
                unicodeRanges = '',
            ...
            if (unicodeRanges) {
                styleElem.innerHTML =
                    '@font-face { ' +
                    '  font-family: "NewSmartGothic";' +
                    '  src: local("' + fontFamilyRegular + '");' +
                    '  font-weight: normal;' +
                    '  unicode-range: ' + unicodeRanges + ';' +
                    '} ' +
                    '@font-face { ' +
                    '  font-family: "NewSmartGothic Bold";' +
                    '  src: local("' + fontFamilyBold + '");' +
                    '  font-weight: normal;' +
                    '  unicode-range: ' + unicodeRanges + ';' +
                    '} ' +
                    '@font-face { ' +
                    '  font-family: "NewSmartGothic Light";' +
